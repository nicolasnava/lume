...
Este repositório possui uma documentação técnica e de negócio completa no arquivo [PROJECT_CONTEXT.md](file:///c:/Users/user/Documents/Projetos/lume/PROJECT_CONTEXT.md).

## Diretrizes Obrigatórias Para Todo Agente:
1. **Consulte o Contexto Mestre:** Antes de propor refatorações ou implementar novas telas, leia sempre o [PROJECT_CONTEXT.md](file:///c:/Users/user/Documents/Projetos/lume/PROJECT_CONTEXT.md).
